...
const translations = {
  th: {
    ...
    home: {
      subtitle: "คลังภาพยนตร์ GIRL LOVE - อัปเดตล่าสุด",
    ...
    schedule: {
      ...
      title: "ตารางออนแอร์",
      desc: "ตารางฉายประจำสัปดาห์ — Girl Love Collection",
      all: "ทั้งหมด",
    ...
    donate: {
      ...
      desc1: "ขอบคุณที่ใช้บริการ GL SHOWTIME",
    ...
    license: {
      ...
      h1: "1. ข้อกำหนดทั่วไป",
      p1: "GL Showtime TH เป็นเพียงเว็บไซต์รวบรวมรายชื่อภาพยนตร์และซีรีส์ (Watchlist Catalog) สำหรับหมวดหมู่ Girl Love (GL) เนื้อหาวิดีโอทั้งหมดถูกดึงมาจากแพลตฟอร์มสาธารณะที่อนุญาตให้ฝังโค้ด (Embed) หรือแชร์ลิงก์ได้",
    ...
    privacy: {
      ...
      p1: "เว็บไซต์ GL Showtime TH ไม่มีการเก็บรวบรวมข้อมูลส่วนบุคคลที่สามารถระบุตัวตนได้จากผู้เข้าชมทั่วไป (Guest) สำหรับผู้ดูแลระบบ (Admin) จะมีการเก็บรักษา Session ในเบราว์เซอร์เพื่อใช้ในการเข้าสู่ระบบเท่านั้น",
  ...
  en: {
    ...
    home: {
      subtitle: "GIRL LOVE COLLECTION - LATEST UPDATES",
    ...
    schedule: {
      subtitle: "Weekly Schedule",
      title: "Air Schedule",
      desc: "Weekly Broadcast Schedule — Girl Love Collection",
      all: "All",
    ...
    donate: {
      title: "Support Us",
      desc1: "Thank you for using GL SHOWTIME",
    ...
    license: {
      ...
      h1: "1. General Terms",
      p1: "GL Showtime TH is a watchlist catalog for the Girl Love (GL) category. All video content is pulled from public platforms that allow embedding or link sharing.",
    ...
    privacy: {
      ...
      p1: "GL Showtime TH does not collect personally identifiable information from general visitors (Guests). For administrators, a browser session is kept strictly for login purposes.",
  ...
  ja: {
    ...
    home: {
      subtitle: "GIRL LOVE コレクション - 最新情報",
      search: "映画を検索...",
      all_genres: "すべてのジャンル",
    ...
    schedule: {
      subtitle: "Weekly Schedule",
      title: "放送スケジュール",
      desc: "週間放送スケジュール — Girl Love Collection",
      all: "すべて",
    ...
    donate: {
      title: "ウェブサイトを支援",
      desc1: "GL SHOWTIMEをご利用いただきありがとうございます",
    ...
    license: {
      ...
      subtitle: "利用規約および著作権",
      h1: "1. 一般条項",
      p1: "GL Showtime THはGirl Love (GL) カテゴリのウォッチリストカタログです。すべての動画コンテンツは埋め込み可能な公開プラットフォームから取得しています。",
      h2: "2. 知的財産権と著作権",
    ...
    privacy: {
      ...
      h1: "1. 収集する情報",
      p1: "一般の訪問者（ゲスト）から個人を特定できる情報を収集することはありません。管理者のみ、ログイン維持のためにセッションを保存します。",
      h2: "2. 情報の利用",
  ...
  lo: {
    ...
    home: {
      subtitle: "คลังหนัง GIRL LOVE - อัปเดตล่าสุด",
    ...
    schedule: {
      subtitle: "Weekly Schedule",
      title: "ต๋ารางออนแอร์",
      desc: "ต๋ารางฉายกู้สัปดาห์ — Girl Love Collection",
      all: "ตึงหมด",
    ...
    donate: {
      ...
      desc1: "ยินดีจ้าดนักตี้ใจ้บริการ GL SHOWTIME",
    ...
    license: {
      ...
      h1: "1. ข้อกำหนดทั่วไป",
      p1: "GL Showtime TH เป๋นก้าเว็บรวบรวมรายชื่อหนังและซีรีส์ สำหรับหมวดหมู่ Girl Love (GL) เนื้อหาวิดีโอตึงหมดดึงมาจากแพลตฟอร์มสาธารณะตี้เปิ้นอนุญาตหื้อฝังโค้ดเน้อ",
      h2: "2. ทรัพย์สินทางปัญญาและลิขสิทธิ์",
    ...
    privacy: {
      ...
      p1: "เว็บ GL Showtime TH บ่เก็บข้อมูลส่วนตั๋วของคนเข้ามาผ่อ (Guest) สำหรับแอดมินเฮาจะเก็บ Session เพื่อเข้าสู่ระบบบ่าดาย",
